...
window.onload = function() {
  ...
  var webGLCurtain2 = new Curtains("canvas2");
  ...
  webGLCurtain2.onError(function() {
    // we will add a class to the document body to display original images
    document.body.classList.add("no-curtains");
  });
  ...
  var plane2 = webGLCurtain2.addPlane(planeElement2, params);
  ...
  plane2 && plane2.onRender(function() {
    plane2.uniforms.time.value++; // update our time uniform value
  });
